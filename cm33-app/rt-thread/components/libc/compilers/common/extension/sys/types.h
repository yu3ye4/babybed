...
/* clock_t must be defined before <time.h> because the toolchain's time.h
 * uses clock_t but its sys/types.h (where clock_t is normally defined) is
 * shadowed by this file in the include search order. */
